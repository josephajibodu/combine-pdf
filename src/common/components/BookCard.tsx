...
const BookCard = ({ pdf, onBookSelected, onBookRemoved }: CardProps) => {
  ...
  return (
    <div onClick={toggleSelection} className="flex w-full relative flex-col bg-white shadow-lg hover:shadow-xl cursor-pointer rounded-lg h-full w-full overflow-hidden">
      <div className="relative overflow-hidden h-16">
        <img src={pdf.thumbnail} alt={pdf.title} className="rounded-lg opacity-50 hover:opacity-100 inset-0 w-full object-cover object-top" />
      </div>
